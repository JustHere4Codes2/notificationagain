<template>
  <main class="page">
    <section class="hero">
      ...
      <p class="hero-desc">
        Trigger notifications with different styles and auto-dismiss behavior.
        Persistent toasts stay until manually closed.
      </p>
    </section>
...
const showWarning = () => {
  const message = 'Warning: please check your input.'
...
const showPersistent = () => {
  const message = 'This toast stays until you close it.'
